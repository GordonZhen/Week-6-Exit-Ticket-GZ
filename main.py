...
# faveshows = [ "Stranger Things" , "Better Call Saul" , "Severance"
# ]
faveshows = [ "Stranger Things" , "Better Call Saul" , "Severance"] 
print(faveshows)
...
for show in faveshows: 
  print(f"{show} is the best show ever!")
...
print(f"How many streams do you think {show} will have this year? \n")
...
# print(playlist[1:4])
# # In the next line, write down what songs showed up in the output: Better Call Saul & Severance
# #
print(faveshows[1:4])
# # In the indexing you just did (playlist[1:4]), if you remove the first index (1), what songs do you think will be in the output? When you omit the first index like that, Python automatically starts your list at the beginning of the list: Stanger Things , Better Call Saul , and Severance
# print(playlist[:4])
print(faveshows[:4])
# # Similarly, if you remove the second index (4), what songs do you think will be in the output? When you omit the second index, Python automatically starts counting from the first index and includes the rest of the list. So, if your first index is 2, that means that your output will start at the element at location 2 (3rd element) and then print out the rest of the list from that location: Severance
#print(playlist[2:])
print(faveshows[2:])
# # How about if your index has a negative number? That just means that you are counting from the back of the list. That means if you put -3, the last three songs from the list will be printed in the output: Stranger Things Better Call Saul and Severance
# print(playlist[-3:])
print(faveshows[-3:])
...
print("These are my top 3 favorite shows at the moment:")
for show in faveshows[:3]:
  print(show)